...
## DoD候補
- [ ] docs/workflows/ 以下に、「spec と実装の差分チェック workflow（Codex 実行前提）」の手順が 1 本のドキュメントとしてまとまっている。
- [ ] 代表的な spec（例: `docs/specs/ui/status_screen.md`, `docs/specs/system/battle_basic.md`）に対して、この workflow を実際に走らせた結果のサンプル（差分メモや Discovery）が 1〜2 件ある。

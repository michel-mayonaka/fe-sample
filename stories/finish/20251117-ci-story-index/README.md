...
- [x] CI ワークフローに Story 検証/索引生成ステップを追加する案が docs/KNOWLEDGE/workflows/ci.md 等に記載されている。
...
- [ ] docs/KNOWLEDGE/workflows/ci.md への反映と Backlog の更新 — `stories/20251117-ci-story-index/tasks/03_docs-and-backlog-update.md`
...
- PR: #
- Issue: #
- Docs: `docs/KNOWLEDGE/workflows/stories.md`, `docs/KNOWLEDGE/workflows/ci.md`, `scripts/gen_story_index.sh`, `scripts/validate_meta.sh`

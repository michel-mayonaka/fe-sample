...
## 完了条件（DoD）
- [x] docs/workflows/ci.md 等に、Story 索引生成/メタ検証のステップが記載されている。
...
- 2025-11-19 01:52:18 +0900: docs/workflows/ci.md に Story 索引生成/メタ検証ステップとエラー時の扱い（非strict/strict）の方針を追記し、discovery `2025-09-30-migrated-01` が `consumed` 状態かつ本ストーリーと相互リンクされていることを確認。現時点で追加の Backlog 登録は不要と判断。

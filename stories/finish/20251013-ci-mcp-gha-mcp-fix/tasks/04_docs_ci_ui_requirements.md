...
## 完了条件（DoD）
- [x] `AGENTS.md` の「よく使うコマンド」「作業開始ルール」に CI での `MCP_STRICT` 取扱を追記。
- [x] `README.md` に Linux での依存導入手順（apt パッケージ例）と `MCP_STRICT=1 make check-ui` の確認手順を追記。
- [x] 変更内容が `make mcp`（docs を含め）で整合している。
...
## 作業ログ
- 2025-10-13 21:13:00 +0900: AGENTS/README に CI 方針とコマンド例を追記（IOP=++）

...
- [x] 必要に応じて `docs/specs/README.md` か `docs/workflows/stories.md` に、spec 状態と Story 運用の関係が1〜2段落で整理されている。
...
- 必要であれば `docs/specs/README.md` や `docs/workflows/stories.md` に、spec 状態と Story/Backlog の役割分担を追記する。
